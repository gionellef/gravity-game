...
public class NoobParadise3 extends Script {
	...
	public NoobParadise3(Engine game, Double region) {
		super(game, region);
	}
	...
	public void onUpdate() {
		...
		if (active) {
			...
			final String[] messages = {"Getting in contact with the red plasma balls will kill you. Be Careful!", ""};
